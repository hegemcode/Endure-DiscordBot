...
client.on("ready", () => {
  ...
  //Change status of the BOT: [iddle, invisible, online, dnd]
...
client.on("message", async message => {
  ...
  //Variables
  let prefix = ".";
  let modRole = "mod"; //Moderator role you need to run certain commands. Enter your server's mod role
  ...
  //Command to google whatever you want
  ...
  if (message.content === `${prefix}help`) {
    const embed = new Discord.RichEmbed() //Display a pretty looking message
      ...
      .addField("Commands", ".anime, .clear, .clear all, .google, .help, .waduhek");
